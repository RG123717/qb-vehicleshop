    ...
    ['pdm'] = {
        ...
        ['Zone'] = {
            ['Shape'] = {--polygon that surrounds the shop
                vector2(-51.19, -1078.99),
                vector2(-58.62, -1099.24),
                vector2(-34.25, -1108.02),
                vector2(-25.73, -1088.31)
            },
        ...
        ['VehicleSpawn'] = vector4(-23.5, -1094.3, 27.12, 340.49), -- Spawn location when vehicle is bought
        ['TestDriveSpawn'] = vector4(-23.5, -1094.3, 27.12, 340.49), -- Spawn location for test drive
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-42.38, -1101.12, 26.27, 32.48), -- where the vehicle will spawn on display
                defaultVehicle = 'adder', -- Default display vehicle
                chosenVehicle = 'adder', -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
                coords = vector4(-50.28, -1084.08, 26.27, 328.39),
                defaultVehicle = 'schafter2',
                chosenVehicle = 'schafter2'
            },
            [3] = {
                coords = vector4(-54.62, -1097.26, 26.27, 152.88),
                defaultVehicle = 'comet2',
                chosenVehicle = 'comet2'
            },
            [4] = {
                coords = vector4(-47.52, -1092.43, 26.27, 263.48),
                defaultVehicle = 'vigero',
                chosenVehicle = 'vigero'
            },
            [5] = {
                coords = vector4(-37.43, -1093.68, 26.27, 261.8),
                defaultVehicle = 't20',
                chosenVehicle = 't20'
            }
        },
